...
read-migration pass, done). **Phase 4 (Frontend) — not started.** Full
detail, every design decision, and current open items are in
[`HANDOFF.md`](./HANDOFF.md) — read that, not this section, for anything
beyond a one-line status check.
